        ...
        public function _dev_import_decisions($path, &$console = '') {
            ...
            try {
                foreach ($data as $idx => $item) {
                    ...
                    $prop = 'Abstract';
                    if (isset($row->$prop)) {
                        $summary = trim($row->$prop);
                    }
                    $type = 'case';
                    $number = NULL;
                    $prop = 'Court decision ID number';
                    if (isset($row->$prop)) {
                        $number = trim($row->$prop);
                    }
